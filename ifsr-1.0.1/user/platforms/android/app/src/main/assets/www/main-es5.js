...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, afAuth, router, translate) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.translate.onLangChange.subscribe(function (event) {
            ...
            if (event.lang == 'ar')
                ...
                dir = 'ltr';
            document.getElementsByTagName("html")[0].setAttribute('lang', _this.lang);
            document.getElementsByTagName("body")[0].setAttribute('dir', dir);
        });
        this.afAuth.auth.onAuthStateChanged(function (user) {
            if (user == null)
                _this.router.navigateByUrl('/login', { replaceUrl: true, skipLocationChange: true });
            else
                _this.router.navigateByUrl('/', { skipLocationChange: true, replaceUrl: true });
        });
    };
...
module.exports = __webpack_require__(/*! C:\Users\rauls\OneDrive\Desktop\version 3\ifsr-1.0.1\user\src\main.ts */"./src/main.ts");
