...
module.exports = "<ion-app>\n  <ion-split-pane>\n    <ion-menu type=\"overlay\">\n      <ion-header>\n        <ion-toolbar>\n\n        </ion-toolbar>\n      </ion-header>\n      <ion-content>\n        <ion-list lines=\"none\">\n          <ion-menu-toggle auto-hide=\"false\" *ngFor=\"let p of appPages\">\n            <ion-item routerLinkActive=\"active-link\" [routerDirection]=\"'root'\" [routerLink]=\"[p.url]\">\n              <ion-icon slot=\"start\" [name]=\"p.icon\"></ion-icon>\n              <ion-label>\n                {{p.title | translate}}\n              </ion-label>\n            </ion-item>\n          </ion-menu-toggle>\n        </ion-list>\n      </ion-content>\n      <ion-footer>\n        <ion-toolbar>\n          <ion-button expand=\"block\" fill=\"clear\" (click)=\"logout()\">Logout</ion-button>\n        </ion-toolbar>\n      </ion-footer>\n    </ion-menu>\n    <ion-router-outlet main></ion-router-outlet>\n  </ion-split-pane>\n</ion-app>"
...
var AppComponent = /** @class */ (function () {
    function AppComponent(platform, splashScreen, statusBar, afAuth, router, translate, menuCtrl, common) {
    ...
    AppComponent.prototype.initializeApp = function () {
        ...
        this.afAuth.auth.onAuthStateChanged(function (data) {
            if (data != null) {
                if (data.email == src_environments_environment_prod__WEBPACK_IMPORTED_MODULE_8__["environment"].adminEmail) {
                    _this.menuCtrl.enable(true);
                    _this.router.navigateByUrl('/');
                }
                else {
                    _this.common.showToast("Not Authorized");
...
var CommonService = /** @class */ (function () {
    ...
    CommonService.prototype.showLoader = function () {
        var _this = this;
        this.loadCtrl.create({ spinner: 'circular', duration: 5000 }).then(function (res) {
            _this.loader = res;
...
module.exports = __webpack_require__(/*! C:\Users\rauls\OneDrive\Desktop\version 3\ifsr-1.0.1\admin\src\main.ts */"./src/main.ts");
