...
module.exports = "#avatar {\n  display: none;\n}\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ProfilePage = /** @class */ (function () {
    ...
    ProfilePage.prototype.ngOnInit = function () {
        var _this = this;
        this.afdb.object('drivers/' + this.afAuth.auth.currentUser.uid).snapshotChanges().subscribe(function (data) {
    ...
    ProfilePage.prototype.upload = function () {
        ...
        var _loop_1 = function (selectedFile) {
            var path = '/drivers/' + Date.now() + ("_" + selectedFile.name);
    ...
    ProfilePage.prototype.update = function () {
        var _this = this;
        this.common.showLoader();
        this.afdb.object('drivers/' + this.afAuth.auth.currentUser.uid).update(this.user).then(function () {
            _this.common.hideLoader();
